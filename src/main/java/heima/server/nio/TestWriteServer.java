...
//                        buffer.flip();
                        ...
                        ByteBuffer respBuffer = ByteBuffer.allocate(1_0000_000);
                        log.debug("response byte length:{}",respBuffer.array().length);
                        int num = channel.write(respBuffer);
                        log.debug("write Byte num {}",num);
                    }else{
